          ...
          <div className="flex flex-col items-start self-stretch">
            ...
            <div className="flex flex-col border-b self-stretch border-[#9F9F9F]">
              <div className="flex gap-[30px] font-medium text-xl">
                <label htmlFor='newPassword' className="text-[#9F9F9F] text-base">NEW PASSWORD</label>
              </div>
              <div
            ...
            <div className="flex flex-col border-b self-stretch border-[#9F9F9F]">
              <div className="flex gap-[30px] font-medium text-xl">
                <label htmlFor='repeatedPassword' className="text-[#9F9F9F] text-base">CONFIRM PASSWORD</label>
              </div>
