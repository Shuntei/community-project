...
export default function AddPost() {
  return (
    <>
      ...
      <div className='bg-zinc-400 grid place-items-center'>
        <div className='w-3/5'>
          ...
          <div className="flex flex-col">
            ...
            <select className="text-black">
              <option value="someOption">汽車</option>
              <option value="otherOption">公車</option>
              <option value="otherOption">捷運</option>
              <option value="otherOption">步行</option>
            </select>
