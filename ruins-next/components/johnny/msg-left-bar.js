...
export default function ChannelAndMsg() {
  return (
    <>
      <section className="fixed mt-[40px] ml-5 hidden bargone:block h-[600px] overflow-scroll pb-20 bg-292929 z-10">
        <div className="text-white mx-10 pt-3 pb-1 text-[20px] ">
          CHANNELS
        </div>
