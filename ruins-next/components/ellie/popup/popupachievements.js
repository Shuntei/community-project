    ...
    <div className="popup absolute left-1/4 top-1/6 py-8 px-8 bg-[#292929] rounded-md border divide-slate-200 w-5/12">
      <div className="popup_inner">
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='gap-2 content-center flex flex-row'>
            <div className='w-10 h-10 flex items-center justify-center bg-gray-600'>
              <div className='w-8 h-8 bg-gray-400 rounded-full flex items-center justify-center'>2</div>
              </div>
            <div className='gap-2'>
          ...
          <div className='gap-2 content-center flex flex-row'>
            <div className='w-10 h-10 flex items-center justify-center bg-gray-600'>
              <div className='w-8 h-8 bg-gray-400 rounded-full flex items-center justify-center'>3</div>
              </div>
            <div className='gap-2'>
                <div className="text-base font-regular font-['IBM Plex Mono'] text-white ">XX is done.  </div>
                <div className="text-sm font-light font-['IBM Plex Mono'] text-white ">Lorem ipsum dolor sit amet consectetur.</div>
          ...
          <div className='gap-2 content-center flex flex-row bg-zinc-700 p-1'>
            <div className='w-10 h-10 flex items-center justify-center bg-zinc-600'></div>
            <div className='gap-2'>
                <div className="text-base font-regular font-['IBM Plex Mono'] text-gray-500 ">XX is done.  </div>
                <div className="text-sm font-light font-['IBM Plex Mono'] text-gray-500 ">Lorem ipsum dolor sit amet consectetur.</div>
            </div>
          </div>
          <div className='gap-2 content-center flex flex-row bg-zinc-700 p-1'>
            <div className='w-10 h-10 flex items-center justify-center bg-zinc-600'></div>
