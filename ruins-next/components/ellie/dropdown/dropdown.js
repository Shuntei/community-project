...
import { RiSubtractLine, RiArrowDownWideFill, RiArrowUpWideFill, RiAddLine } from "@remixicon/react";
...
export default function Dropdown() {
  ...
  const handleChange = (e) => {
    const noteValue = e.currentTarget.getAttribute('data-value')
    setNote(noteValue)
    router.push(
      {
        pathname: '/game',
        query: { main_note: noteValue },
      },
      undefined,
      { scroll: false }
    )
        ...
        <div className='flex flex-col '>
          <div className='flex flex-col mt-4'>
              <div className='inline-flex gap-30 border-b-2 border-black mb-3'>
                ...
                {showAchievements ? <RiAddLine onClick={toggleAchievements} /> : <RiSubtractLine onClick={toggleAchievements} />}
              </div>
              ...
              <div className='inline-flex gap-32 border-b-2 border-black mb-3'>
                ...
                {showNotes ? <RiAddLine onClick={toggleNotes} /> : <RiSubtractLine onClick={toggleNotes} />}
              </div>
