  ...
  return (
    <group {...props} dispose={null} scale={5}>
      ...
      <mesh
        ...
        scale={0.01}
      />
      <group position={[0, -0.722, 0]} rotation={[Math.PI / 2, -Math.PI / 2, 0]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
      ...
      <mesh
        ...
        scale={0.01}
      />
      <group position={[0, -0.451, 0]} rotation={[Math.PI / 2, 0, -0.192]} scale={0.01}>
      ...
      <group position={[0, -0.311, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
      ...
      <mesh
        ...
        scale={0.01}
      />
      <group position={[0, -1.83, 0]} rotation={[Math.PI / 2, 0, -0.91]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[0, 1.164, 0]} rotation={[Math.PI / 2, 0, -1.257]} scale={0.01}>
      ...
      <group position={[0, -0.05, 0]} rotation={[Math.PI, -1.366, Math.PI / 2]} scale={0.01}>
        ...
        <group position={[0, -78.181, -240.617]} rotation={[-Math.PI / 10, 0, 0]}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0, -148.71, -204.681]} rotation={[-Math.PI / 5, 0, 0]}>
          <mesh
            castShadow
            receiveShadow
      ...
      <mesh
        ...
        scale={0.01}
      />
      <group position={[0, 0.788, 0]} rotation={[Math.PI / 2, 0, -0.175]} scale={0.01}>
      ...
      <group position={[0, -1.008, 0]} rotation={[Math.PI / 2, -Math.PI / 2, 0]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[0, -1.008, 0]} rotation={[0, -1.257, -Math.PI / 2]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
      ...
      <mesh
        ...
        scale={0.01}
      />
      <group position={[0, -1.082, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        <mesh
          castShadow
          receiveShadow
