...
// export default function KeyboardControls({ map }) {
//   const keyboardMap = useMemo(() => [
//     { name: useControls.forward, keys: ["ArrowUp", "KeyW"] },
//     { name: useControls.back, keys: ["ArrowDown", "KeyS"] },
//     { name: useControls.left, keys: ["ArrowLeft", "KeyA"] },
//     { name: useControls.right, keys: ["ArrowRight", "KeyD"] },
//     { name: useControls.jump, keys: ["Space"] },
//   ], []);
