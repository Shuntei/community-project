...
export default function Notification({
  ...
  return (
    <>
      ...
      className="flex gap-[12px] items-start p-[5px] hover:bg-[--main-bg] cursor-pointer hover:bg-[#2e2e2e]">
        <div className="h-[50px] min-w-[50px] rounded-full overflow-y-hidden">
          <Image 
          onClick={(e)=>{
            e.stopPropagation()
            router.push(userLink)}}
          alt="" width={50} height={50} src={src} className="min-w-[50px] max-w-[50px] min-h-[50px] object-cover bg-cover" />
        </div>
        ...
        <div className="h-[50px] min-w-[50px] overflow-y-hidden">
          <Image 
          alt="" width={50} height={50} src={postSrc} className="min-w-[50px] max-w-[50px] min-h-[50px] object-cover bg-cover" />
        </div>
        : ''}
      </div>
    </>
